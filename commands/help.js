...
exports.run = async (client, message, args) => {
  ...
  **[${prefix}yardım Genel](https://discord.gg/K767EtDJ)** 
  **[${prefix}yardım Eğlence](https://discord.gg/K767EtDJ)**
  **[${prefix}yardım Moderasyon](https://discord.gg/K767EtDJ)**
  **[${prefix}yardım Sunucu](https://discord.gg/K767EtDJ)**
  **[${prefix}yardım Sahip](https://discord.gg/K767EtDJ)**
  `)
    .addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=847070972774449173&scope=bot&permissions=2108157183)` + "** | **" + `[Destek Sunucusu](https://discord.gg/K767EtDJ)` + "** | **" + `[Web Sitesi](https://yarligan.net/)  `, false)

    .setFooter('Bu komutu kullanan kullanıcı ' + message.author.tag, message.author.displayAvatarURL())
  message.channel.send(embed)

  //DESTEK SUNUCUSU : https://discord.gg/2vPdmYz
}
...
exports.conf = {
  ...
  kategori: "Genel" //Yardım komutunda hangi kategoride gözükeceğini configsınız
